...
# This file generates asm code for state leakage experiment (2)
...
# experiment config 'exp_XXX_leakmat')
# AAA aa,bb
# movs r7,r7
# movs r7,r7
# movs r7,r7
# BBB r7, r7 <-- random values to ~hopefully~ erase leakage
# movs r7,r7
# movs r7,r7
# movs r7,r7
# AAA cc,dd  <-- check for no leakage here
#
import random
import sys
...
insts_g_eor = ['eors','adds', 'ands', 'bics','cmps', 'movs', 'orrs', 'subs']
insts_cls_eor = [0,0,0,0,0,0,0,0]
...
def init_push(a, r1, r2, inp_offset, out_offset):
    ...
    return (a, inp_offset, out_offset)
def mid_init_value(a, r1, r2, inp_offset, out_offset):
    a += ['@ mid init value',
            'movs {}, r7'.format(r1),
            'movs {}, r7'.format(r2),
         ]
    return (a, inp_offset, out_offset)
def mid_init_pop(a, r1, r2, inp_offset, out_offset):
    a += ['@ mid init value',
            'movs {}, r7'.format(r1),
            'movs {}, r7'.format(r2),
            'push {{{}}}'.format('r7')
...
def mid_init_ldr(a, r1, r2, inp_offset, out_offset):
    a += ['@ mid init ldr',
        'movs {}, #0'.format(r1),
        'ldr {}, =R'.format(r2)
        ]
    return (a, inp_offset, out_offset)
def mid_init_str(a, r1, r2, inp_offset, out_offset):
    a += ['@ mid init str',
        'ldr {}, =T32'.format(r1),
        'movs {}, r7'.format(r2)
        ]
...
mid_insts_init = [mid_init_value, mid_init_value, mid_init_str, mid_init_ldr, mid_init_value, mid_init_pop, mid_init_value]
mid_insts_finit = [finit_dummy,finit_dummy,finit_dummy,finit_dummy,finit_dummy, finit_dummy, mid_finit_push]
...
a, inp_offset, out_offset = mid_insts_init[insts_cls[inst2]](a, 'r0','r1', inp_offset, out_offset)
a, inp_offset, out_offset = insts_init[insts_cls[inst1]](a, 'r2','r3', inp_offset, out_offset)
a, inp_offset, out_offset = insts_init[insts_cls[inst1]](a, 'r4','r5', inp_offset, out_offset)
...
a = insts_pad(a,'r7')
a = insts_pad(a,'r7')
a = insts_run[insts_cls[inst2]](a, insts[inst2], 'r0','r1')
a = insts_pad(a,'r7')
a = insts_pad(a,'r7')
a = insts_pad(a,'r7')
a = insts_pad(a,'r7')
a = insts_pad(a,'r7')
a = insts_run[insts_cls[inst1]](a, insts[inst1], 'r4','r5')
a = insts_pad(a,'r7')
a = insts_pad(a,'r7')
a = insts_pad(a,'r7')
a = insts_pad(a,'r7')
...
a = mid_insts_finit[insts_cls[inst2]](a,'r0','r1')
a = insts_finit[insts_cls[inst1]](a,'r2','r3')
