#! /usr/bin/python3
import sys
insts_idxs1 = [int(sys.argv[2])]
insts_idxs2 = [int(sys.argv[3])]
insts_idxs3 = [int(sys.argv[4])]
...
for inst1 in insts_idxs1:
    for inst2 in insts_idxs2:
        for inst3 in insts_idxs3:
            inp_offset = 0
            out_offset = 0
            a = []
            c0 = Context()
